...
const EstateDetails = () => {
    ...
    return (
        <div className='mx-5 md:mx-0'>
            ...
            <div className='h-[330px] lg:h-[450px] grid grid-cols-5 grid-rows-2 gap-4 '>
                {/* <div className='col-span-5 md:col-span-3 row-span-2 w-full h-full relative bg-black estate'>
                    <img className='w-full h-full  rounded-xl' src={image} alt="" />
                    <div className='absolute top-[50%] left-[50%] '>
                        <p className='text-white text'>{segment_name}</p>
                        <h4 className='text-white text'>{estate_title}</h4>
                        <h6 className='text-white text'>{status}</h6>
                    </div>
                </div> */}
                ...
                <div
                    ...
                    style={{
                        // backgroundImage: `linear-gradient(to right, rgba(21, 11, 43, 0.90), rgba(21, 11, 43, 0.60)), url(${image})`,
                ...
                >
                    <div className='flex flex-col justify-center items-center h-full'>
                        <p className='text-white md:text-4xl font-bold font-heading md:mb-1.5'>{segment_name} for {status}</p>
                        <h4 className='text-white md:text-2xl font-description mb-2 md:mb-3.5'>{estate_title}</h4>
                        <h6 className='text-white lg:w-[70%] text-center text-sm '>{short_description}</h6>
                    </div>
                </div>
            ...
            <div className='flex lg:flex-row flex-col gap-10 my-10'>
                <div className='lg:w-3/4'>
                    ...
                    <div className='grid md:grid-cols-2 gap-y-3 gap-x-8 my-4 lg:w-3/4 bg-gradient-to-r from-[rgba(204,204,204,0.45)] hover:shadow-lg to-[rgba(230,230,230,.25)] rounded-lg px-6 py-8'>
                        <div>
                        ...
                        <div>
                            ...
                            <div className=' h-[1px] bg-[rgba(5,191,219)] mt-1.5 w-[70%]'></div>
                        </div>
                        <div>
